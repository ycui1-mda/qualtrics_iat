...
class IATTask:
    ...
    def __init__(self,
        ...
        self.overall_instruction_desktop = self._get_overall_instruction(mobile=False)
        self.overall_instruction_mobile = self._get_overall_instruction(mobile=True)
        self.reminder_instruction_desktop = self._get_reminder_instruction(mobile=False)
        self.reminder_instruction_mobile = self._get_reminder_instruction(mobile=True)
        self.shows_examples = kwargs.get("shows_examples", False)
        self.example_duration = kwargs.get("example_duration", 1500)
        self.example_instruction = self._get_example_instruction()
    ...
    def custom_params(name):
        ...
        if name == IATTask.templates_names[1]:
            ...
            params.update(
                ...
                attribute_positive_stimuli="Executive Management Professional Corporation Salary Office Business Career".split(),
    ...
    def _get_overall_instruction(self, mobile):
        paged_instruction = [
    ...
    def _get_example_instruction(self):
        return [
            f"<br /><br /><br />"
    ...
    def _get_reminder_instruction(self, mobile):
        if mobile:
        ...
        return [
            ...
            f"<li style='text-align: left;'>Press <strong>the {displayed_left_key_name} {response_element} with your left "
            f"index finger</strong> if the {self._stimuli_types_singular} fits the category on the left.</li>"
            f"<li style='text-align: left;'>Press <strong>the {displayed_right_key_name} {response_element} with your right "
